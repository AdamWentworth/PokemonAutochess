...
void runFrame(int& framesRemaining,
    ...
    out << "[Init] World/board prewarm frame "
        << frameIndex << "/" << totalFrames << " begin\n";
...
void schedule(int& framesRemaining,
    ...
    out << "[Init] World/board prewarm scheduled: frames=" << framesRemaining
...
void drainStartupFrames(int& framesRemaining,
    ...
    while (framesRemaining > 0) {
        ...
        runFrame(framesRemaining, totalFrames, drawableW, drawableH, callbacks, out);
