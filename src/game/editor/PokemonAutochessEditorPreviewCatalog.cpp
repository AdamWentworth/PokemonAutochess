...
constexpr Definitions kDefinitions{{
    ...
    },
    {
        ...
        "Grass Test",
        "North Entrance",
        "Bulbasaur starts in the lower grass bed while Rattata searches the upper terrace. Play to inspect concealment, rustling, ledge jumps and the eastern ramp.",
        "snapshot",
        "classic",
    ...
    },
    {
        ...
        "Planning",
        "North Entrance",
        "Place Pokemon at the northern end of Route 1, with two open terraces, a broad grass bed, the original eastern ramp and clear dirt benches.",
        "route_planning",
        "classic",
