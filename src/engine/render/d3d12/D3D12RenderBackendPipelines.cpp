...
void D3D12RenderBackend::createWorldPipeline() {
    ...
    static constexpr char kVsSource[] =
        ...
        "  if (w0 > 0.00001f && j0 >= 0 && j0 < c && j0 < kMaxSkinMatrices) blended += mul(loadSkinMatrix(j0, c), float4(localPos, 1.0f)) * w0;"
        "  if (w1 > 0.00001f && j1 >= 0 && j1 < c && j1 < kMaxSkinMatrices) blended += mul(loadSkinMatrix(j1, c), float4(localPos, 1.0f)) * w1;"
        "  if (w2 > 0.00001f && j2 >= 0 && j2 < c && j2 < kMaxSkinMatrices) blended += mul(loadSkinMatrix(j2, c), float4(localPos, 1.0f)) * w2;"
        "  if (w3 > 0.00001f && j3 >= 0 && j3 < c && j3 < kMaxSkinMatrices) blended += mul(loadSkinMatrix(j3, c), float4(localPos, 1.0f)) * w3;"
        ...
        "  int j2 = (int)round(i.jnts.z); float w2 = i.wgts.z;"
        "  int j3 = (int)round(i.jnts.w); float w3 = i.wgts.w;"
        "  if (w0 > 0.00001f && j0 >= 0 && j0 < c && j0 < kMaxSkinMatrices) blended += mul((float3x3)loadSkinMatrix(j0, c), localNormal) * w0;"
        "  if (w1 > 0.00001f && j1 >= 0 && j1 < c && j1 < kMaxSkinMatrices) blended += mul((float3x3)loadSkinMatrix(j1, c), localNormal) * w1;"
        "  if (w2 > 0.00001f && j2 >= 0 && j2 < c && j2 < kMaxSkinMatrices) blended += mul((float3x3)loadSkinMatrix(j2, c), localNormal) * w2;"
        "  if (w3 > 0.00001f && j3 >= 0 && j3 < c && j3 < kMaxSkinMatrices) blended += mul((float3x3)loadSkinMatrix(j3, c), localNormal) * w3;"
        ...
        "  int j2 = (int)round(i.jnts.z); float w2 = i.wgts.z;"
        "  int j3 = (int)round(i.jnts.w); float w3 = i.wgts.w;"
        "  if (w0 > 0.00001f && j0 >= 0 && j0 < c && j0 < kMaxSkinMatrices) blended += mul((float3x3)loadSkinMatrix(j0, c), tangent) * w0;"
        "  if (w1 > 0.00001f && j1 >= 0 && j1 < c && j1 < kMaxSkinMatrices) blended += mul((float3x3)loadSkinMatrix(j1, c), tangent) * w1;"
        "  if (w2 > 0.00001f && j2 >= 0 && j2 < c && j2 < kMaxSkinMatrices) blended += mul((float3x3)loadSkinMatrix(j2, c), tangent) * w2;"
        "  if (w3 > 0.00001f && j3 >= 0 && j3 < c && j3 < kMaxSkinMatrices) blended += mul((float3x3)loadSkinMatrix(j3, c), tangent) * w3;"
        "  float len2 = dot(blended, blended);"
