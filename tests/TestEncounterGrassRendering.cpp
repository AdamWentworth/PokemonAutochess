...
bool test_encounter_grass_rendering(std::string &outFail) {
    ...
    for (const auto *variant : {&variants::kRoute1Pilot, &variants::kRoute1SouthClearing}) {
        ...
        const auto actor = variant == &variants::kRoute1Pilot ? world.gridToWorld(7, 4) : world.gridToWorld(6, 3);
