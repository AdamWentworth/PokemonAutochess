...
bool test_runtime_perf_accumulator_contract(std::string& outFail) {
    ...
    a.fastSceneInstances = 10;
    a.fastSceneDrawClasses = 2;
    a.fastSceneVisibleSkeletons = 1;
    a.fastScenePaletteUploadBytes = 1024;
    a.fastSceneMaterialTableBinds = 3;
    a.fastSceneIndirectCommands = 4;
    ...
    b.fastSceneInstances = 18;
    b.fastSceneDrawClasses = 4;
    b.fastSceneVisibleSkeletons = 3;
    b.fastScenePaletteUploadBytes = 5120;
    b.fastSceneMaterialTableBinds = 5;
    b.fastSceneIndirectCommands = 8;
    ...
    if (std::fabs(perf.fps - (2.0f / 1.1f)) > 0.01f ||
        ...
        perf.fastSceneInstances != 14 ||
        perf.fastSceneDrawClasses != 3 ||
        perf.fastSceneVisibleSkeletons != 2 ||
        perf.fastScenePaletteUploadBytes != 3072u ||
        perf.fastSceneMaterialTableBinds != 4 ||
        perf.fastSceneIndirectCommands != 6 ||
